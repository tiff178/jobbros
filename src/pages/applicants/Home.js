      ...
      <div data-layer="Home Page" className="HomePage" style={{width: 1440, height: 1024, position: 'relative', background: 'white', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
        <div data-layer="Frame 37" className="Frame37" style={{justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
          <div data-layer="Site Bar" className="SiteBar" style={{width: 484, height: 1024, paddingLeft: 82, paddingRight: 82, paddingTop: 124, paddingBottom: 124, background: '#81D8D0', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 95, display: 'inline-flex'}}>
            ...
            <div onClick={() => handleLogout()} data-layer="Logout Button" className="LogoutButton" style={{paddingLeft: 100, paddingRight: 100, paddingTop: 34, paddingBottom: 34, background: 'black', borderRadius: 20, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
        ...
        <div data-layer="Frame 10" className="Frame10" style={{top: '150px', right: '20px', position: 'absolute', height: 733, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 101, display: 'inline-flex'}}>
          <div onClick={() => navigate("/jobs")}  data-layer="job-search" className="JobSearch" style={{alignSelf: 'stretch', height: 110, paddingLeft: 40, paddingRight: 40, paddingTop: 73, paddingBottom: 73, background: '#D9D9D9', borderRadius: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
          ...
          <div onClick={() => navigate("/track")} data-layer="application-tracking" className="ApplicationTracking" style={{alignSelf: 'stretch', height: 110, paddingLeft: 40, paddingRight: 40, paddingTop: 73, paddingBottom: 73, background: '#D9D9D9', borderRadius: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
            <div data-layer="Application Tracking" className="ApplicationTracking" style={{textAlign: 'center', color: 'black', fontSize: 35, fontFamily: 'Outfit', fontWeight: '700', wordWrap: 'break-word'}}>
                Application Tracking
            </div>
          </div>
          <div onClick={() => navigate("/saved")} data-layer="saved-jobs" className="SavedJobs" style={{alignSelf: 'stretch', height: 100, paddingLeft: 40, paddingRight: 40, paddingTop: 73, paddingBottom: 73, background: '#D9D9D9', borderRadius: 20, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
